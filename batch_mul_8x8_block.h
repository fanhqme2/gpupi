...
// 8x8 multiplication block macro
// Performs 64 multiply-accumulate operations on registers
// Parameters:
//   av1, av2 - uint4 vectors containing a values (8 x 32-bit)
//   bv1, bv2 - uint4 vectors containing b values (8 x 32-bit)
//   r0v, r1v, r2v, r3v - uint4 vectors for results (16 x 32-bit accumulated)
//   carryv1, carryv2 - uint4 vectors for carries
#define BATCH_MUL_8X8_BLOCK(av1, av2, bv1, bv2, r0v, r1v, r2v, r3v, carryv1, carryv2) \
    do { \
